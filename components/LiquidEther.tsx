...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class MouseClass {
      ...
      init(container: HTMLElement) {
        this.container = container;
        // Listen globally so cursor movement over siblings (e.g., hero content) still affects the background
      ...
      onDocumentMouseMove(event: MouseEvent) {
        // Track whether the pointer is inside the component bounds
        if (this.container) {
          const rect = this.container.getBoundingClientRect();
          this.isHoverInside =
